  ...
  return (
    <div className="min-h-screen bg-[#0e0d0d]">
      <main className="relative z-10">
        <section
          id="hero"
          className="relative min-h-screen bg-gradient-to-t from-primary to-transparent p-8"
        >
          <div className="fixed inset-x-0 top-20 h-[60vh] md:top-20 md:h-[100vh]">
            <Particles
          ...
          <div className="mb-32 mt-40 flex flex-col items-center justify-center gap-y-6 text-center">
